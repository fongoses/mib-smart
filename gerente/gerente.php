<?php
    ...
    $generalGet_1 = snmpget("192.168.0.105", "private", "1.3.6.1.4.1.12619.1.1.1.0");
    $general_1=str_replace("\"","",explode(": ",$generalGet_1)[1]);

    $generalGet_2 = snmpget("192.168.0.105", "private", "1.3.6.1.4.1.12619.1.1.2.0");
    $general_2=str_replace("\"","",explode(": ",$generalGet_2)[1]);

    $generalGet_3 = snmpget("192.168.0.105", "private", "1.3.6.1.4.1.12619.1.1.3.0");
    $general_3=str_replace("\"","",explode(": ",$generalGet_3)[1]);

    $generalGet_4 = snmpget("192.168.0.105", "private", "1.3.6.1.4.1.12619.1.1.4.0");
